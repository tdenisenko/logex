...
- Commits made this run: `fix: tighten public ipv6 address detection`; `docs: record strict ipv6 proof`; pending `fix: apply dual p2p families to consensus dials`.
