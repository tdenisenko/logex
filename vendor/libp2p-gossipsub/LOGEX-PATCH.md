...
The retained upstream integration `smoke` target additionally requires unpublished
test support (`libp2p-swarm-test`); it is not part of the standalone library gate.
