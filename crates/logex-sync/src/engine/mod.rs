...
pub(super) struct HistoricalQueuedFetchPlan {
    sequence: u64,
...
pub struct SyncEngine {
    ...
    historical_fetch_ready_plans: BTreeMap<u64, HistoricalQueuedFetchPlan>,
...
impl SyncEngine {
    pub fn new(
        ...
        Self {
            ...
            historical_fetch_ready_plans: BTreeMap::new(),
