...
/// Fixed-size per-segment presence filter for ERC20 Transfer sender/receiver
/// keys. It is intentionally only a segment skip index: query execution still
