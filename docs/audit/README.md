...
| 9 | Dashboard, metrics, health, status | In progress: [dashboard/status review](dashboard-observability.md) implements reproduced status, polling, result/export, range, chart and accessibility fixes. Source `d375e95b` passes independent review and all twelve local gates (2,074 Rust tests / 24 ignores, 36 browser controls). Exact-head CI and merge remain. |
