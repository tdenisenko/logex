...
as `84a7889d` after all six CI jobs passed. The current pass reviews [custom aggregate predicates, nulls and integer semantics](sql-aggregate-semantics.md).
